	...
	public static void main(String[] args) {
		JedinkaFactroy fact = new JedinkaFactroy() {
			...
			public Jedinka create() {
				return new NeuralNetowrkAsteroids(28,50,30,4);
			}
		};
...
//			System.out.println();
//		}
		Evolution darwin = new Evolution(300, fact);
		Vector in = new Vector(28);
		System.out.println(darwin.run(1000, 1, 5000)-1);
//		Game game = new Game();
//		game.newGame();
//		while (!game.isOver()) {
...
//		System.out.println(game.getScore());
		((NeuralNetwork)darwin.getBest()).saveTo("src/main/resources/NN");;
	}
